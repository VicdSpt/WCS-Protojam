  ...
  if(gameOver) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-900 via-indigo-950 to-slate-900 flex flex-col items-center justify-center gap-6">
        ...
        <h2 className="text-white text-4xl font-bold tracking-tight">Game Over</h2>
        <p className="text-indigo-300 text-lg">Your final score is: <span className="text-white font-bold">{score}</span></p>
        <button
